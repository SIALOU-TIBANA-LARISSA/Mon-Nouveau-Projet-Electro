    ...
    try {
        ...
        container.innerHTML = `
            <div class="bg-white border rounded-lg p-6 mb-4">
                ...
                <p><strong>Total :</strong> <span class="text-orange-500 font-bold">${order.total_amount} FCFA</span></p>
        ...
        container.innerHTML = "<p class='text-red-500'>Impossible d’afficher cette commande.</p>";
    }
});
</script>
@endsection
